...
SEARCH_DIR("/opt/gcc.4.2/i586-pc-interix3/lib"); SEARCH_DIR("/opt/gcc.4.2/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/dev/fs/F/Windows/SUA//usr/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
