...
void    print_high_scores(), done_proc() ;
void	quit_proc(), start_proc(), pause_proc(), newgame_proc();
void	resume_proc(), about_proc();
void    drop_block(), restore_widget(), show_score();
void	end_game(), left_proc(), right_proc();
