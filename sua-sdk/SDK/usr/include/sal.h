...
// buffer macros. These may be used to enrich existing annotations with additional
// information.
//
// __checkReturn v :
...
// nothing, and do not affect the compiled code.
    ...
    //
    // Annotates a buffer pointer p as being readable to a size that cannote be expressed in SAL.
    //
    ...
    //
    // Annotates a buffer pointer p as being writable to a size that cannote be expressed in SAL.
    //
