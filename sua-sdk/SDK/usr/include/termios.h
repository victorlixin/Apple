...
#define CRTS_IFLOW	0x00001000	/* RTS flow control of input */	
#define CCTS_OFLOW	0x00002000	/* CTS flow control of output */
#define CDTR_IFLOW	0x00004000	/* DTR flow control of input */	
#define CDSR_OFLOW	0x00008000	/* DSR flow control of output */
#define CRTSCTS		(CCTS_OFLOW |CRTS_IFLOW)	/* RTS/CTS flow control bidirectional enable		*/
#define CDTRDSR		(CDSR_OFLOW |CDTR_IFLOW)	/* DTR/DSR flow control bidirectional enable		*/
 ...
 */
#define TTYALL_CFLAG (CLOCAL|CREAD|CSIZE|CSTOPB|HUPCL|PARENB|PARODD|CRTSCTS|CDTRDSR)
